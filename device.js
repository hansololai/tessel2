...
Device.prototype.getIp=function(){
	...
	for (var key in interfaces){
		if(interfaces.hasOwnProperty(key)){
			var cur=interfaces[key]
			var tmp=_.find(cur,function(i){
				if (i['family'].toLowerCase()=="ipv4") return true;
			});
			if(tmp) toReturn[key]=tmp['address']
		}
	}
	this.ip_address=toReturn['eth0'] || toReturn['Ethernet'] || toReturn['wlan0']||"127.0.0.1" ;
